...
## Corpus Check
- 280 files · ~182,503 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3245 nodes · 6032 edges · 213 communities (157 shown, 56 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 399 edges (avg confidence: 0.77)
...
Cohesion: 0.11
Nodes (16): AuthRequest, ArgonService, Injectable, COOKIE_OPTIONS, AuthService, Injectable, AuthResponseDto, UserDto (+8 more)
...
Cohesion: 0.05
Nodes (34): compute_diversification(), Compute portfolio diversification and concentration metrics. Parameters…, Verify Component A, Component B, and composite score against hand traces. Score…, 3-asset 50/30/20: comp_a = 87.7193., Without correlation data: comp_b = 50 (neutral assumption)., Score = 0.60×87.7193 + 0.40×50 = 72.6316., 5-asset equal-weight with known matrix: rho_bar = 0.22., rho_bar=0.22 → comp_b = (1-0.22)/2 × 100 = 39.0. (+26 more)
...
Cohesion: 0.10
Nodes (16): CreateTransactionDto, IsEnum, IsNotEmpty, IsOptional, IsString, IsUUID, Min, Type (+8 more)
...
### Community 38 - "risk/__init__.py"
Cohesion: 0.06
Nodes (31): BetaResult, compute_beta(), Beta Calculator =============== Pure-math module for computing the systematic…, Beta computation output. Attributes ---------- asset_id : Portfolio or security…, Compute the portfolio beta against a benchmark. Algorithm --------- 1.…, DrawdownResult, Maximum Drawdown Calculator ============================= Pure-math module for…, Maximum Drawdown computation output. Attributes ---------- asset_id : Portfolio… (+23 more)

### Community 44 - "analytics.dto.ts"
Cohesion: 0.08
Nodes (42): AnalyticsClientService, Injectable, AnalyticsModule, Module, AnalyticsController, Body, Controller, HttpCode (+34 more)
...
Cohesion: 0.06
Nodes (36): _component_a(), _component_b(), _compute_hhi(), ConcentrationRatio, DiversificationResult, _normalise_weights(), Diversification & Concentration Analytics Engine…, Single Top-N concentration ratio result. Attributes ---------- n : The top-N… (+28 more)

### Community 47 - "routers/risk.py"
Cohesion: 0.08
Nodes (47): Convert a series of simple daily returns to a cumulative NAV curve., _returns_to_nav(), compute_correlation_matrix(), compute_diversification_analytics(), compute_drawdown_series(), compute_risk_summary(), _map_var_estimate(), post (+39 more)
...
Cohesion: 0.11
Nodes (20): compute_allocation(), PositionRecord, Return the classification label for the position on the requested dimension., Aggregate portfolio positions into allocation buckets by the given dimension.…, A single portfolio position with its market value and classification labels.…, _resolve_label(), Normalisation holds even when Unassigned / Other bucket is present., All 5 group_by dimensions produce valid results. (+12 more)
...
Cohesion: 0.09
Nodes (15): compute_sharpe(), Compute the annualised Sharpe Ratio from a series of daily returns. Algorithm…, Validates quantitative risk metrics against R package 'PerformanceAnalytics'…, Benchmark: R PerformanceAnalytics::VaR(R, p=0.95, method="historical") With 20…, Benchmark: R PerformanceAnalytics::SharpeRatio.annualized(R, Rf=0.04), Benchmark: R PerformanceAnalytics::SortinoRatio(R, MAR=0.04) Sortino ratio…, Benchmark: R PerformanceAnalytics::maxDrawdown(R) Computes maximum peak-to-…, Benchmark: R stats::lm(R ~ Benchmark) Beta = Cov(R, R_m) / Var(R_m) Both series… (+7 more)

### Community 64 - "AllocationWeight"
Cohesion: 0.09
Nodes (23): AllocationWeight, compute_rebalance(), Compute portfolio drift and required buy/sell amounts to reach target weights.…, A single bucket weight entry for rebalance input. Attributes ---------- label :…, Validates portfolio drift and rebalance math guaranteeing the fundamental…, Portfolio total value = 1,000,000. Current: Equity 70% (700k), Debt 30% (300k).…, TestRebalanceZeroSumBenchmark, Total buy amount must equal total sell amount (pure redistribution). Validated… (+15 more)
...
### Community 83 - "compute_volatility"
Cohesion: 0.09
Nodes (17): compute_volatility(), Annualised Volatility Calculator ================================== Pure-math…, Annualised volatility output. Attributes ---------- asset_id : Identifier…, Compute annualised volatility from a series of daily periodic returns.…, VolatilityResult, Verify annualised volatility against hand-computed reference values. Dataset A…, Daily volatility must match hand-computed Bessel-corrected std dev., Annual volatility = daily_vol × √252 with strict tolerance. (+9 more)

### Community 85 - "PrismaService"
Cohesion: 0.15
Nodes (7): JwtPayload, JwtStrategy, Injectable, InsufficientCashException, InsufficientHoldingException, PrismaService, Injectable
...
Cohesion: 0.11
Nodes (17): AlertModule, Module, AuthModule, Module, CalculatorModule, Module, MarketDataModule, Module (+9 more)

### Community 93 - "alert.module.ts"
Cohesion: 0.12
Nodes (12): RuleEvaluationSummary, AlertEventListener, HoldingUpdatedEvent, PortfolioUpdatedEvent, Injectable, InjectQueue, ALERT_JOBS, ALERT_NOTIFICATION_QUEUE (+4 more)
...
### Community 167 - "AuthController"
Cohesion: 0.22
Nodes (10): AuthController, Body, Controller, Get, HttpCode, Post, Req, Res (+2 more)
...
### Community 178 - "analytics/__init__.py"
Cohesion: 0.17
Nodes (12): AllocationBucket, AllocationResult, Asset Allocation Aggregation Engine ===================================== Pure-…, Full allocation breakdown result for a portfolio. Attributes ----------…, A single allocation bucket representing one group within a dimension.…, Analytics math package for the Wealth Compass Quant Engine. Public API: twr —…, Portfolio Rebalance Drift Calculation Engine…, Complete rebalance calculation result. Attributes ---------- portfolio_id :… (+4 more)
...
### Community 191 - "NotificationProcessor"
Cohesion: 0.40
...
### Community 194 - "TestDojHhiConcentrationBenchmarks"
Cohesion: 0.20
...
### Community 195 - "RegisterDto"
Cohesion: 0.29
Nodes (7): RegisterDto, IsEmail, IsNotEmpty, IsOptional, IsString, Matches, MinLength

### Community 196 - ".validate_aligned_lengths"
Cohesion: 0.29
...
### Community 197 - "TestCashPortfolio"
Cohesion: 0.29
...
### Community 198 - "JwtRefreshStrategy"
Cohesion: 0.33
Nodes (3): JwtRefreshPayload, JwtRefreshStrategy, Injectable

### Community 199 - "TestZeroVolatilityAsset"
Cohesion: 0.33
...
### Community 200 - "TestPerfectlyInversePair"
Cohesion: 0.40
...
## Knowledge Gaps
- **577 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+572 more)
...
- **Why does `compute_diversification()` connect `compute_diversification` to `TestEffectiveNInvariants`, `TestConcentrationRatioBenchmark`, `TestConcentrationRatioInvariants`, `TestDojHhiConcentrationBenchmarks`, `risk/__init__.py`, `TestEdgeCasesAndErrorHandling`, `TestDiversificationEndpointSmoke`, `TestEffectiveNBenchmark`, `test_diversification.py`, `routers/risk.py`, `TestHhiBenchmark`, `TestCompositeScoreInvariants`, `analytics/__init__.py`, `TestHhiInvariants`, `TestSectorHhiInvariants`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `PrismaService` connect `PrismaService` to `AlertEvaluatorEngine`, `auth.module.ts`, `alert-evaluator.engine.ts`, `valuation.engine.ts`, `report.module.ts`, `PortfolioService`, `alert.service.ts`, `app.module.ts`, `portfolio.service.ts`, `pdf-report.service.ts`, `market-data.service.spec.ts`, `CreateTransactionDto`, `ExcelExportService`, `MarketDataService`, `market-data.module.ts`, `alert.module.ts`?**
