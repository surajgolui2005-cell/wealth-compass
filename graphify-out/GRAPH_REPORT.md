# Graph Report - Investor Portolio Monitoring and Risk Management System  (2026-09-07)

## Corpus Check
- 393 files · ~250,361 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4028 nodes · 7332 edges · 267 communities (196 shown, 71 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 492 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ffb372be`
...
- `TestAllocationRouterHappyPath` --uses--> `PositionRecord`  [INFERRED]
  apps/quant-engine/tests/test_allocation.py → apps/quant-engine/src/analytics/allocation.py
- `TestDojHhiConcentrationBenchmarks` --uses--> `AllocationWeight`  [INFERRED]
  apps/quant-engine/tests/test_quant_benchmarks.py → apps/quant-engine/src/analytics/rebalance.py
- `TestExcelXirrBenchmarks` --uses--> `AllocationWeight`  [INFERRED]
  apps/quant-engine/tests/test_quant_benchmarks.py → apps/quant-engine/src/analytics/rebalance.py
- `TestGipsTwrBenchmarks` --uses--> `AllocationWeight`  [INFERRED]
  apps/quant-engine/tests/test_quant_benchmarks.py → apps/quant-engine/src/analytics/rebalance.py

## Import Cycles
- None detected.

## Communities (267 total, 71 thin omitted)

### Community 0 - "providers.module.ts"
Cohesion: 0.12
Nodes (13): ManualEntryAdapter, Injectable, ConnectAccountDto, ImportCsvDto, SyncProviderDto, CsvColumnMapping, CsvParseResult, FinancialDataProvider (+5 more)
...
Cohesion: 0.08
Nodes (18): compute_drawdown(), DrawdownResult, Maximum Drawdown Calculator ============================= Pure-math module for…, Compute the Maximum Drawdown from either a daily return series or a NAV series.…, Maximum Drawdown computation output. Attributes ---------- asset_id : Portfolio…, Convert a series of simple daily returns to a cumulative NAV curve., _returns_to_nav(), Benchmark: R PerformanceAnalytics::maxDrawdown(R) Computes maximum peak-to-… (+10 more)
...
### Community 11 - "portfolio.controller.ts"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (15): 3.10 `portfolio_snapshots`, 3.11 `risk_metric_snapshots`, 3.12 `alert_rules`, 3.13 `alert_logs`, 3.14 `reports`, 3.1 `users`, 3.2 `user_preferences`, 3.3 `portfolios` (+7 more)
...
Cohesion: 0.21
Nodes (7): PriceQuote, buildPriceCacheKey(), buildPriceMetaKey(), CachedPriceEntry, resolveTtlForAssetClass(), PriceCacheService, Injectable
...
Cohesion: 0.19
Nodes (16): AssetAllocationDto, PortfolioValuationSummaryDto, PositionValuationDto, RealizedGainDto, FifoCalculator, FifoLot, Injectable, CalcMethod (+8 more)
...
### Community 44 - "schemas/performance.py"
Cohesion: 0.11
Nodes (24): compute_benchmark_endpoint(), compute_xirr_endpoint(), post, POST /api/v1/performance/xirr Cash flow sign convention: - **Negative** = money…, POST /api/v1/performance/benchmark Accepts aligned portfolio NAV and benchmark…, Convert decimal to percentage, returning NaN-safe float., _safe_pct(), BenchmarkRequest (+16 more)

### Community 45 - "alerts/page.tsx"
Cohesion: 0.12
Nodes (17): LoginForm, loginSchema, RegisterForm, registerSchema, AlertForm, AlertRule, alertSchema, AlertsPage() (+9 more)
...
Cohesion: 0.07
Nodes (46): Routers sub-package — FastAPI router modules for all analytics endpoints., compute_correlation_matrix(), compute_diversification_analytics(), compute_drawdown_series(), compute_risk_summary(), _map_var_estimate(), post, Risk Analytics Router ===================== Exposes four computation endpoints:… (+38 more)
...
### Community 50 - "src/analytics/__init__.py"
Cohesion: 0.06
Nodes (57): AllocationBucket, AllocationResult, compute_allocation(), GroupBy, PositionRecord, Asset Allocation Aggregation Engine ===================================== Pure-…, Full allocation breakdown result for a portfolio. Attributes ----------…, Return the classification label for the position on the requested dimension. (+49 more)
...
Cohesion: 0.07
Nodes (29): dependencies, axios, bullmq, class-validator, @investor-pm/types, papaparse, passport, passport-jwt (+21 more)
...
Cohesion: 0.15
Nodes (14): ASSET_CLASS_TTL_MAP, CACHE_TTL, MARKET_DATA_JOBS, MARKET_DATA_QUEUE, PRICE_CACHE_KEY_PREFIX, PriceCacheMetadata, STALENESS_THRESHOLD, pipelineMock (+6 more)
...
Cohesion: 0.13
Nodes (12): compute_sharpe(), Sharpe Ratio Calculator ======================== Pure-math module for computing…, Sharpe Ratio computation output. Attributes ---------- asset_id : Portfolio or…, Compute the annualised Sharpe Ratio from a series of daily returns. Algorithm…, SharpeResult, Benchmark: R PerformanceAnalytics::SharpeRatio.annualized(R, Rf=0.04), Sharpe Ratio = (mean_daily_excess × 252) / (daily_vol × √252) =…, Dataset A mean return > rf daily → Sharpe must be positive. (+4 more)
...
### Community 81 - "date"
Cohesion: 0.06
Nodes (46): CashFlowEvent, compute_twr(), _modified_dietz(), Time-Weighted Return (TWR) — Sub-Period Compounding Engine…, Output of the TWR computation. Attributes ---------- twr_cumulative: Cumulative…, Computes the Modified Dietz return for a single sub-period. Formula: R = (EMV -…, Computes the Time-Weighted Return (TWR) via sub-period chain-linking. The…, An external cash flow event within a sub-period. Attributes ---------- date:… (+38 more)
...
### Community 85 - "PortfolioService"
Cohesion: 0.10
Nodes (15): TransactionController, Body, Controller, Get, HttpCode, Param, Post, Req (+7 more)

### Community 86 - "src/hooks/useCopilotChat.ts"
Cohesion: 0.11
Nodes (23): CopilotDrawer(), CopilotMessageProps, CopilotContext, CopilotContextValue, CopilotProvider(), toConversationHistory(), useCopilotContext(), nanoid() (+15 more)

### Community 89 - "risk/__init__.py"
Cohesion: 0.14
Nodes (14): BetaResult, Beta Calculator =============== Pure-math module for computing the systematic…, Beta computation output. Attributes ---------- asset_id : Portfolio or security…, Risk Analytics Sub-Package for the Wealth Compass Quant Engine. This package…, _quantile(), Value at Risk (VaR) Calculator ================================ Pure-math…, Full VaR computation output covering both methods and both confidence levels.…, Compute the p-th quantile of a pre-sorted list using linear interpolation… (+6 more)

### Community 91 - "portfolios/page.tsx"
Cohesion: 0.18
Nodes (16): Holding, PortfolioDetail, PortfolioDetailPage(), CreateForm, createSchema, Portfolio, PortfoliosPage(), EmptyState() (+8 more)

### Community 92 - "app.module.ts"
Cohesion: 0.11
Nodes (18): AnalyticsModule, Module, AuthModule, Module, JwtRefreshPayload, JwtRefreshStrategy, Injectable, CalculatorModule (+10 more)
...
Cohesion: 0.12
Nodes (20): metadata, metrics, sampleBenchmarkData, sampleEquityData, metadata, quickLinks, metadata, riskMetrics (+12 more)
...
Cohesion: 0.12
Nodes (10): JwtPayload, JwtStrategy, Injectable, InsufficientCashException, InsufficientHoldingException, PortfolioNotFoundException, HoldingService, Injectable (+2 more)
...
Cohesion: 0.10
Nodes (14): compute_sortino(), Sortino Ratio Calculator ========================= Pure-math module for…, Compute the annualised Sortino Ratio from a series of daily returns. Algorithm…, Sortino Ratio computation output. Attributes ---------- asset_id : Portfolio or…, SortinoResult, Benchmark: R PerformanceAnalytics::SortinoRatio(R, MAR=0.04) Sortino ratio…, Sortino Ratio = (R_a - rf_annual) / σ_DD_a σ_DD² = Σ[min(r_i - MAR_daily, 0)²]…, Dataset A has 3 days below the MAR (days 3, 4, 8). (+6 more)
...
Cohesion: 0.29
Nodes (8): MetricCard(), MetricCardProps, styles, classifyDelta(), formatCurrency(), formatPercent(), DashboardSummary, styles
...
Cohesion: 0.17
Nodes (12): useAuth(), IoniconName, MainTabParamList, Tab, TAB_ICONS, DashboardScreen(), RISK_METRICS, RiskScreen() (+4 more)
...
### Community 135 - "PortfoliosScreen.tsx"
Cohesion: 0.24
Nodes (7): apiClient, ApiError, Props, styles, Portfolio, PortfoliosScreen(), styles
...
Cohesion: 0.17
Nodes (3): CsvProviderAdapter, Injectable, Optional
...
Cohesion: 0.13
Nodes (21): AaAccountPayloadDto, AaBankAccountData, AaBankTransactionData, AaDematHoldingData, AaEncryptedConsentToken, AaFiType, AaHandle, AaMutualFundData (+13 more)
...
Cohesion: 0.15
Nodes (6): CryptoModule, Global, Module, EncryptedPayload, EncryptionService, Injectable
...
### Community 191 - "RbiAccountAggregatorAdapter"
Cohesion: 0.19
Nodes (3): RbiAccountAggregatorAdapter, Injectable, RawExternalHolding
...
### Community 196 - "analytics.controller.ts"
Cohesion: 0.20
Nodes (10): AnalyticsClientService, Injectable, AnalyticsController, Controller, UseGuards, UseInterceptors, BenchmarkComputeRequest, BenchmarkResponseDto (+2 more)
...
### Community 213 - "CreateTransactionDto"
Cohesion: 0.14
Nodes (13): JwtAuthGuard, Injectable, CreateTransactionDto, IsEnum, IsNotEmpty, IsOptional, IsString, IsUUID (+5 more)
...
### Community 215 - "MarketDataService"
Cohesion: 0.21
...
### Community 218 - "HealthController"
Cohesion: 0.26
Nodes (7): ApiOperation, ApiResponse, ApiTags, HealthController, Controller, Get, Res

### Community 224 - ".computeAllocation"
Cohesion: 0.23
Nodes (9): Body, HttpCode, Post, AllocationComputeRequest, AllocationResponseDto, DiversificationComputeRequest, DiversificationResponseDto, RebalanceComputeRequest (+1 more)

### Community 232 - "TestCrashRecoveryRegime"
Cohesion: 0.20
...
### Community 236 - "cn"
Cohesion: 0.13
Nodes (16): CopilotTrigger(), CopilotTriggerProps, StarterChips(), StarterChipsProps, CopilotMessage(), renderInline(), renderMarkdown(), ACTION_STYLES (+8 more)

### Community 237 - "Data Dictionary — Wealth Compass Platform"
Cohesion: 0.20
Nodes (10): 1.1 Precision Tiers, 1.2 System Audit Conventions, 1. Overview & Financial Precision Standards, 2. Entity Model Catalog, 4. Enumeration Reference Guide, 5.1 `transaction.recorded`, 5.2 `holding.updated`, 5.3 `portfolio.updated` (+2 more)

### Community 240 - "pdf-report.service.ts"
Cohesion: 0.16
...
### Community 248 - "CurrencyConverterService"
Cohesion: 0.32
...
### Community 250 - "ObservabilityModule"
Cohesion: 0.67
Nodes (3): ObservabilityModule, Global, Module

### Community 257 - ".validate_aligned_lengths"
Cohesion: 0.29
...
### Community 260 - "AlertEventListener"
Cohesion: 0.33
Nodes (4): AlertEventListener, Injectable, InjectQueue, OnEvent

### Community 262 - "excel-export.service.spec.ts"
Cohesion: 0.40
...
## Knowledge Gaps
- **802 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+797 more)
...
- **Why does `compute_diversification()` connect `compute_diversification` to `TestConcentrationRatioBenchmark`, `TestComponentScoresBenchmark`, `TestEdgeCasesAndErrorHandling`, `TestDiversificationEndpointSmoke`, `TestEffectiveNBenchmark`, `TestConcentrationRatioInvariants`, `TestEffectiveNInvariants`, `TestHhiBenchmark`, `test_diversification.py`, `routers/risk.py`, `date`, `src/analytics/__init__.py`, `TestCompositeScoreInvariants`, `risk/__init__.py`, `TestHhiInvariants`, `TestSectorHhiInvariants`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `PrismaService` connect `PrismaService` to `providers.module.ts`, `AlertEvaluatorEngine`, `health.service.ts`, `AuthService`, `CsvProviderAdapter`, `market-data.service.spec.ts`, `AnalyticsCacheManager`, `valuation.engine.ts`, `market-data.module.ts`, `alert-evaluator.engine.ts`, `PortfolioService`, `MarketDataService`, `CoinGeckoProvider`, `app.module.ts`, `alert.module.ts`, `report.module.ts`, `ExcelExportService`, `PdfReportService`, `alert.service.ts`, `pdf-report.service.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `compute_benchmark_metrics()` connect `compute_benchmark_metrics` to `date`, `src/analytics/__init__.py`, `schemas/performance.py`?**
...
- **Should `providers.module.ts` be split into smaller, more focused modules?**
