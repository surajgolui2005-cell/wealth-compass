...
Cohesion: 0.29
Nodes (7): packages/config/_, packages/shared-types/src/index.ts, packages/ui-components/src/index.ts, paths, @investor-pm/config/_, @investor-pm/types, @investor-pm/ui
